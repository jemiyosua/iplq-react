...
import './modal-detail-transaksi-iuran.css'
...
const ModalDetailTransaksiIuran = ({ showModal, listDetailTransaksiIuran, onClickClose, orderID, transaksiID, statusTransaksi}) => {
    return (
        <Modal
            show={showModal}
            size="lg"
        ...
        >
            <Modal.Body>
                ...
                <h5 style={{ color:'#0f2f0f', fontWeight:'bold' }}>Detail Transaksi Iuran</h5>
                ...
                <div className="table-responsive">
                    ...
                    <thead style={{ backgroundColor: '#0b3d0b', color: '#FFFFFF'}}>
						...
						<tbody>
                            ...
                            {listDetailTransaksiIuran?.map((item, index) => (
                                <tr key={index} >
